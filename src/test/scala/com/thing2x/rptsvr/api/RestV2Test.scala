...
import akka.http.scaladsl.model.{ContentType, HttpEntity, HttpResponse, MediaRange, MediaType, StatusCodes}
  ...
  "reportunit" should "be written" in {
    val reportUnitReq = HttpEntity(ContentType(`application/repository.reportUnit+json`),
      s"""
        ...
        |      "permissionMask":1,
        |      "type":"jrxml",
        |      "uri":"/$foldername/${reportunitname}_files/main_jrxml","version":-1
        |    }
        |  },
        |  "label":"$reportunitname",
        |  "permissionMask":1,
        |  "resources":{
        |    "resource":[
        |      {
        ...
        |             "version": 0,
        |             "permissionMask": 1,
        |             "creationDate": "2019-04-29T08:40:13",
        |             "updateDate": "2019-04-29T08:40:13",
        |             "label": "plane.png",
        |             "uri": "/$foldername/${reportunitname}_files/plane.png",
        |             "type": "img",
        |             "content": ""
        |          }
        |        }
